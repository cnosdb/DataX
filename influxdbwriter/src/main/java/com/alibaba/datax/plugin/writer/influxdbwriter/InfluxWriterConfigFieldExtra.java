...
public class InfluxWriterConfigFieldExtra {
    ...
    public InfluxWriterConfigFieldExtra(Configuration config) {
        this.table = config.getString(InfluxDBWriter.CFG_TABLE);
        this.field = config.getString(InfluxDBWriter.CFG_FIELD);
        this.tagsExtra = config.getMap(InfluxDBWriter.CFG_TAGS_EXTRA, String.class);
        if (this.tagsExtra == null) {
            this.tagsExtra = new HashMap<>();
        }
    }

    public InfluxWriterConfigFieldExtra(String table, String field, Map<String, String> tagsExtra) {
        this.table = table;
        this.field = field;
    ...
    public boolean equals(Object o) {
        ...
        InfluxWriterConfigFieldExtra that = (InfluxWriterConfigFieldExtra) o;
