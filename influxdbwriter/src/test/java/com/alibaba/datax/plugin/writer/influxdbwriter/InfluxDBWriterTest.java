...
public class InfluxDBWriterTest extends TestCase {
    public void testInitWithFormatNormal() {
        ...
        InfluxDBWriter.Task task = new InfluxDBWriter.Task();
    ...
    public void testInitWithFormatOpenTSDB() {
        ...
        assertEquals(
                ...
                new InfluxWriterConfigFieldExtra("t3", "f1", new HashMap<String, String>() {{
                    put("t1", "1");
                    put("t2", "2");
                }}));
        assertEquals(
                task.fieldsExtra.get("f2"),
                new InfluxWriterConfigFieldExtra("t4", "f2", new HashMap<String, String>() {{
                    put("t3", "3");
                    put("t4", "4");
                }}));
